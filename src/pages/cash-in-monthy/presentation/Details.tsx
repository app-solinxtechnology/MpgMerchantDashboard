...
import DetailCashInMonthlyListTable from "$List/detail-cash-in-monthly";
import { useNavigate } from "react-router-dom";



const DetailCashInMonthly = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <DetailCashInMonthlyListTable/>
    </div>
  );
};

export default DetailCashInMonthly;
