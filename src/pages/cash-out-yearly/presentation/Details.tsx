...
import DetailCashOutYearlyListTable from "$List/detail-cash-out-yearly";
import { useNavigate } from "react-router-dom";



const DetailCashOutYearly = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <DetailCashOutYearlyListTable/>
    </div>
  );
};

export default DetailCashOutYearly;
