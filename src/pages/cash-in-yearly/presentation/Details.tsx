...
import DetailCashInYearlyListTable from "$List/detail-cash-in-yearly";
import { useNavigate } from "react-router-dom";



const DetailCashInYearly = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <DetailCashInYearlyListTable/>
    </div>
  );
};

export default DetailCashInYearly;
