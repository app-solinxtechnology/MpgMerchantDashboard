...
const Edit:React.FC<IEditProps> = ({handleEditOpen,editOpen,handleEditClose}) => {
  ...
  return (
        ...
        <DialogBody placeholder={"dashboard-dialogbody"} >
          <p className="text-xl mb-3 text-black">Edit Admin</p>
          <p className="mb-3 text-black">
            Make Edit to Admin here. Click save when you're done.
          </p>
          <form >
            ...
            <div className=" mt-7">
              <div className="w-full flex justify-center">
                <Button onClick={handleEditClose} placeholder={"button"} className="bg-white text-black capitalize font-[500] mr-3">
                    Cancel
                </Button>
