...
import DetailCashOutMonthlyListTable from "$List/detail-cash-out-monthly";
import { useNavigate } from "react-router-dom";



const DetailCashOutMonthly = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <DetailCashOutMonthlyListTable/>
    </div>
  );
};

export default DetailCashOutMonthly;
