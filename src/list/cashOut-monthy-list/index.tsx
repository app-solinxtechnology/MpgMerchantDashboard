  ...
  return (
    ...
    <td>{entry.no}</td>
          ...
          <td>{entry.transaction_status}</td>
           {/* <td>
              <Button onClick={()=>navigate('/dashboard/cash-out-order/Monthly/detail')} variant="outlined" className="capitalize font-[400] button-item  " color="blue" size="sm"  placeholder={"button"}>view</Button>
           </td> */}
        </tr>
      ))}
    </tbody>
...
const CashOutMonthlyListTable = ({loading,data}:any) => {
  const columns = [
    "no",
    "Date",
    "Transaction Id",
  ...
  return (
    <div ref={ref} className="w-full bg-white px-5 pt-5 overflow-x-scroll  pb-10 relative min-h-[300px]  rounded-md shadow-sm  cursor-pointer">
...
export default CashOutMonthlyListTable;
