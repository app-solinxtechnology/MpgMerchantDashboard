  ...
  return (
    <tbody className="text-[13px]">
        ...
        >
          ...
          <td>{entries?.monthly_income} Ks</td>
        </tr>
...
const MonthlyIncomeListTable = ({loading,data}:any) => {
  const columns = [
    "No",
    "Total Users",
    "Total Incomes",
  ...
  return (
    <div className="w-full bg-white  px-5 pt-5 overflow-x-scroll  pb-10 relative min-h-[160px]  rounded-md shadow-sm  cursor-pointer">
...
export default MonthlyIncomeListTable;
